...
import (
	...
	"tidb/kv"
	"tidb/meta/autoid"
	plannercore "tidb/planner/core"
	"tidb/privilege/privileges"
	"tidb/session"
	"tidb/sessionctx"
	"tidb/sessionctx/binloginfo"
...
func (s *testSessionSuite) TestAutoIncrementWithRetry(c *C) {
	// test for https://tidb/issues/827
...
func (s *testSessionSuite) TestResultType(c *C) {
	// Testcase for https://tidb/issues/325
	tk := testkit.NewTestKitWithInit(c, s.store)
...
func (s *testSessionSuite) TestUnique(c *C) {
	...
	// Test for https://tidb/issues/463
...
func (s *testSessionSuite) TestSet(c *C) {
	// Test for https://tidb/issues/1114
